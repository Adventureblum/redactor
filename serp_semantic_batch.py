    ...
    async def process_file(self, filepath: str, query_data: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            result = {
                ...
                'detailed_clusters': enriched_context["clusters_thematiques"],
                'semantic_relations': enriched_context["relations_semantiques"],
                'strategic_entities': enriched_context["entites_importantes"]
            }
        ...
        for query in consigne_data.get('queries', []):
            ...
            if query_id in processed_results:
                ...
                query.update({
                    ...
                    'detailed_clusters': result_data.get('detailed_clusters', {}),
                    'semantic_relations': result_data.get('semantic_relations', []),
                    'strategic_entities': result_data.get('strategic_entities', [])
                })
